...
## News
- **First Written Exam Session (01/13/2022):** Registrations are now open via Google Form at the following <a href="https://forms.gle/XK9GuTk4p4HQZko99" target="_blank">link</a>. In order to access the form you must login to your institutional Google account. Please, notice that this poll closes on **Tuesday, January 11, 2022 at 11:59 p.m. CET**; only students that manifest their willing to participate by that time will be allowed to attend the exam. In case you change your mind and you don't want to participate to this exam session anymore, please update your answer on the form accordingly as this will significantly help me with the organization of the test.<br/>
As a reminder, this exam session is scheduled for **Thursday, January 13, 2022 from 2:00 p.m. to 3:00 p.m. CET** in **Aula Informatica 15**, located in Via Tiburtina, 205 ([map](https://goo.gl/maps/TgnJCWDfx2VQRo4u5)).<br/>
