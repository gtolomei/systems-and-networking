...
This exam session is scheduled for **Tuesday, January 27, 2026, in the afternoon** in **Aula Informatica 17**, located in Via Tiburtina, 205 ([map](https://goo.gl/maps/TgnJCWDfx2VQRo4u5)). Further details regarding the exam's organization, including the number of rounds and the exact schedule, will be communicated closer to the exam date.<br/>
**NOTE:** _Students who are sure they will not attend this exam session **should not** fill out this form! Besides, everyone can decide to opt in by the closing date of this poll._
