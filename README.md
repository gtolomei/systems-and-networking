...
## News
- **Written Exam Session II (01/31/2022):** This session will take place **exclusively online from remote**. There will be **two separate turns**: the first one is scheduled **from 3:00 p.m. to 4:00 p.m. CET**; the second turn, instead, will (tentatively) **start at 5:00 p.m. until 6:00 p.m. CET**.
